...
<title>About Us - Project Management Club DBS</title>
...
<style>
  ...
  *, *::before, *::after {
  ...
  section {
    background: white;
    border-radius: 15px;
    box-shadow: 0 10px 25px rgba(22, 49, 114, 0.1);
...
<main class="container" role="main" aria-label="About Project Management Club DBS">

  <h1>About Us</h1>

  <section aria-labelledby="about-club-title">
    <h2 id="about-club-title">The Project Management Club at DBS</h2>
    <p>
  ...
  <section aria-labelledby="mission-title">
    <h2 id="mission-title">Mission Alignment</h2>
    <p>
  ...
  <section aria-labelledby="values-title">
    <h2 id="values-title">Core Values and Practices of PMI</h2>
    <p>
